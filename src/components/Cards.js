            ...
            <div className='card-container-left'>
                ...
                <div className='gc-text'>
                    ...
                    <p className='gc-caption'>
                        ...
                        simply direct message us on <a href="https://www.instagram.com/gt.msa?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer">Instagram</a> or email us to request an invite to our group chat.
                    </p>
                </div>
            </div>
        </div>
